#!/usr/bin/env python3
"""Fetch AU/NZ agriculture RSS feeds, extract short summaries, and build a
static dashboard (docs/index.html) for GitHub Pages. Stdlib only, no deps.
"""
import html
import json
import os
        ...
        items.append(
            {
                "title": title,
                "link": link,
                "summary": summarize(clean_text(desc)),
...
<footer>Sources: {source_list}. Summaries are auto-extracted excerpts, not AI-generated.</footer>
<script>
